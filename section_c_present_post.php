        ...
        <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" class="md:px-10 py-5">
            ...
            <div class="flex flex-col md:flex-row w-full gap-x-4">
                <div class="py-3 md:w-2/3">
                    <label class='text-gray-800 font-medium text-sm'>Title of Post: <sup class='text-red-600'></sup></label>
                    <div class="py-1">
                            <input type="text" name="title_of_post" required  class="border py-3 rounded-md px-3 text-lg shadow-md 
            ...
            <div class="flex flex-col md:flex-row w-full gap-x-4">
                <div class="py-3 md:w-1/2">
                    ...
                    <div class="py-1">
                            <textarea name="surname" required class="border py-3 rounded-md px-3 text-lg shadow-md 
                ...
                <div class="flex flex-col py-3 md:w-1/2 gap-y-2">
                        <div>
                            ...
                            <div class='py-1'>
                                    <input type="text" name="home_phone" class="border py-3 md:py-2 rounded-md px-3 text-lg shadow-md 
                                                                                        focus:outline-none focus:ring-1 focus:ring-sky-300/50 focus:border-sky-400" style="width:100%;" />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class='py-1'>
                                    <input type="text" name="home_phone" class="border py-3 md:py-2 rounded-md px-3 text-md shadow-md 
                                                                                        focus:outline-none focus:ring-1 focus:ring-sky-300/50 focus:border-sky-400" style="width:100%;" />
                            </div>
                        </div>                       
                </div>
            ...
            <div class="py-3 md:w-full">
                    ...
                    <div class="py-1">
                            <input type="text" name="email" required  class="border py-3 rounded-md px-3 text-lg shadow-md 
                                                                         focus:outline-none focus:ring-1 focus:ring-sky-300/50 focus:border-sky-400" style="width:100%;" />
                    </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row w-full gap-x-4">
                ...
                <div class="py-3 md:w-1/2">
                    ...
                    <div class='py-1'>
                            <textarea type="date" name="permit_expire_date" class="border py-3 rounded-md px-3 text-lg shadow-md 
                                                                                focus:outline-none focus:ring-1 focus:ring-sky-300/50 focus:border-sky-400 h-48" style="width:100%;" ></textarea>
                    </div>
                </div>
            </div>
            <!-- End of work permit //-->
