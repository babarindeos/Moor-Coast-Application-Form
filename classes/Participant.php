...
class Participant
{
    ...
    public function get_all_participants()
    {
        ...
        {             
                ...
                $query = "Select p.user_id, u.email, p.prefix, p.firstname, p.lastname, p.institution, p.country, 
                          p.phone, p.created_at from ".$this->table_name." p inner join users u on u.user_id=p.user_id" ;
    ...
    public function create()
    {
        ...
        {             
                ...
                $query = "Insert into ".$this->table_name." set 
                            user_id=:user_id, prefix=:prefix, firstname=:firstname, lastname=:lastname, 
                            institution=:institution, country=:country, phone=:phone";
                
                $stmt = $this->conn->prepare($query);

                // posted values
                $this->user_id = htmlspecialchars(strip_tags((string) $this->user_id));
                $this->prefix = htmlspecialchars(strip_tags((string) $this->prefix));
                $this->firstname = htmlspecialchars(strip_tags((string) $this->firstname));
                $this->lastname = htmlspecialchars(strip_tags((string) $this->lastname));
                $this->institution = htmlspecialchars(strip_tags((string) $this->institution));
                $this->country = htmlspecialchars(strip_tags((string) $this->country));
    ...
    public function update()
    {
        ...
        {             
                ...
                $query = "Update ".$this->table_name." set 
                            ...
                            institution=:institution, country=:country, phone=:phone where  user_id=:user_id";
