...
class UserCategory
{
    ...
    public function get_user_category()
    {
         try
        {
            $query = "Select uc.user_category_id, uc.user_id, uc.category_id, c.category_id, c.name from ".$this->table_name." uc
                       inner join categories c on uc.category_id=c.category_id where uc.user_id=:user_id";
    ...
    public function create()
    {
        ...
        try
        {
                ...
                $this->category_id = htmlspecialchars(strip_tags((string) $this->category_id));
    ...
    public function update()
    {
        ...
        try
        {
                ...
                $query = "Update ".$this->table_name." set 
                            category_id=:category_id where user_id=:user_id";
                ...
                else
                {
                    $data = [
                        'status' => 'fail',
                        'message' => "An error occurred updated the record"
                    ];
