...
class Payment
{
    ...
    public function create()
    {
        ...
        {             
                ...
                if (isset($this->receipt) && $this->receipt['error'] === UPLOAD_ERR_OK) {
                    $uploadDir  = __DIR__ . '/uploads/receipts/';
                
                    // Extract the original file extension (e.g., .jpg, .png)
                    $ext = pathinfo($this->receipt['name'], PATHINFO_EXTENSION);
                    ...
                    if (move_uploaded_file($this->receipt['tmp_name'], $targetPath)) {
                        $this->receipt = $fileName; // save only the name or relative path
                    } else {
                ...
                $query = "Insert into ".$this->table_name." set 
                            user_id=:user_id, category=:category, payer=:payer, amount=:amount, receipt=:receipt";
                ...
                $this->payer = htmlspecialchars(strip_tags((string) $this->payer));
                $this->amount = htmlspecialchars(strip_tags((string) $this->amount));
                $this->receipt = $fileName;
                

                $stmt->bindParam(":user_id", $this->user_id);
                $stmt->bindParam(":category", $this->category);
                $stmt->bindParam(":payer", $this->payer);
    ...
    public function update()
    {
        ...
        {             
                ...
                $query = "Update ".$this->table_name." set 
                            ...
                            amount=:amount, receipt=:receipt where user_id=:user_id";
